...
public class CreditCard extends Card{
    ...
    public CreditCard(String cardNumber, LocalDate expirationDate, int ccv, Account account, String owner, boolean active, double creditLimit, double interestRate){
    ...
    public void makePayment(double amount, String description, TransactionType type, LocalDate date){
        ...
        */
        ...
        transactionService.performTransaction(getAccount(), amount, description, type, date);
    }
    ...
    public void applyInterest(LocalDate date){
        ...
        */
        ...
        String description = "Interest on credit";
        TransactionService transactionService = new TransactionService();
        transactionService.performTransaction(getAccount(), interest, description, TransactionType.INTEREST, date);
    }
